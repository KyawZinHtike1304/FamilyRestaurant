  ...
  return (
    <div className='mx-w-[1520px] m-auto text-white px-4 bg-[#24262b]'>
      ...
      <div className='md:col-span-2 my-4'>
        ...
        <p>Sign up to join our news letter and stay up to date.</p>
      ...
      <div className='my-4'>
        <div className='flex flex-col sm:flex-row items-center justify-between w-full'>
          ...
          <button className='bg-[#00ff9a] text-white rounded-md font-medium w-[200px] ml-4 my-6 px-6
          py-3 border-none'>Notify Me</button>
        </div>
